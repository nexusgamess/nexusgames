...
function generarHTMLJuego(datos, nombreImagen, fechaActual) {
    ...
    if (datos.link_caido === 'true' || datos.link_caido === true) {
        ...
        <a href="${datos.link}" target="_blank" class="btn btn-utorrent-verde btn-lg fw-bold px-5 py-3 mb-2">
            <i class="fa-solid fa-magnet me-2"></i> DESCARGAR JUEGO BASE
        </a>`;
...
<head>
    ...
    <style>
        /* Estilos específicos para esta página de juego */
        .seccion-titulo {
            color: #ff5722; 
        ...
        .lista-cuadrada li, .lista-requisitos li {
            margin-bottom: 10px;
        }
        ...
        /* Colores exactos de los botones de descarga */
        .btn-utorrent-verde {
            background-color: #0b7a38 !important; 
            ...
            <div class="collapse navbar-collapse" id="menuNavegacion">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-uppercase fw-semibold" style="font-size: 0.85rem;">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link text-white px-3 dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Categorías
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdownCategorias">
                            ...
                            <li><a class="dropdown-item d-flex align-items-center" href="../index.html?cat=aventura"><i class="fa-solid fa-map-location-dot me-2 text-warning"></i> Aventura</a></li>
                            ...
                            <li><a class="dropdown-item fw-bold text-center text-info" href="../index.html">VER TODAS LAS CATEGORÍAS...</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdownRequisitos">
                ...
                <div class="d-flex align-items-center gap-3 ms-lg-3 mt-3 mt-lg-0">
                        <a href="https://www.youtube.com/@nexus-games-everyone" target="_blank" class="text-white fs-5"><i class="fa-brands fa-youtube hover-rojo"></i></a>
                        <a href="https://discord.gg/K5xKACqWQ" target="_blank" class="text-white fs-5"><i class="fa-brands fa-discord hover-rojo"></i></a>
                    <form action="../index.html" method="GET" class="d-flex ms-auto">
                        ...
                        <button class="btn btn-dark rounded-pill px-3 shadow-sm" type="submit">
    ...
    <div class="container mt-4 mb-5">
        ...
        <nav aria-label="breadcrumb" class="mb-3">
            <ol class="breadcrumb" style="font-size: 0.85rem;">
                ...
                <li class="breadcrumb-item"><a href="../index.html?cat=${(datos.categoria || '').toLowerCase()}" class="text-decoration-none text-muted">${datos.categoria}</a></li>
        ...
        <div class="row">
            ...
            <div class="text-center">
                    <h3 class="seccion-titulo">Ficha Técnica</h3>
                </div>
                <ul class="lista-cuadrada fs-6 ms-3 mb-5">
                    ...
                    <li><strong>FECHA DE ACTUALIZACIÓN:</strong> <span class="text-danger">${datos.fecha_actualizacion || fechaActualFallback}</span></li>
                    ${datos.textos ? `<li><strong>TEXTOS:</strong> ${datos.textos}</li>` : ''}
                    ${datos.audio ? `<li><strong>AUDIO:</strong> ${datos.audio}</li>` : ''}
                </ul>

                <div class="text-center">
                    <h3 class="seccion-titulo">Gameplay Trailer</h3>
                </div>
                <div class="ratio ratio-16x9 mb-5">
                    <iframe src="https://www.youtube.com/embed/${datos.video}" title="YouTube video player" allowfullscreen></iframe>
                </div>

                <div class="text-center">
                    <h3 class="seccion-titulo">Requisitos del Sistema</h3>
                </div>
                <div class="mb-5">
                    ...
                    <ul class="lista-cuadrada lista-requisitos ms-3 mb-4">
                        ...
                        <li><strong>SO:</strong> ${datos.min_so}</li>
                        <li><strong>Procesador:</strong> ${datos.min_cpu}</li>
                        <li><strong>Memoria:</strong> ${datos.min_ram}</li>
                        <li><strong>Gráficos:</strong> ${datos.min_gpu}</li>
                        <li><strong>DirectX:</strong> ${datos.min_dx}</li>
                        <li><strong>Almacenamiento:</strong> ${datos.min_disco}</li>
                    </ul>

                    <p class="fs-5 mb-3">RECOMENDADOS:</p>
                    <ul class="lista-cuadrada lista-requisitos ms-3 mb-4">
                        <li>Requiere un procesador y un sistema operativo de 64 bits</li>
                        <li><strong>SO:</strong> ${datos.rec_so}</li>
                        <li><strong>Procesador:</strong> ${datos.rec_cpu}</li>
                        <li><strong>Memoria:</strong> ${datos.rec_ram}</li>
                        <li><strong>Gráficos:</strong> ${datos.rec_gpu}</li>
                        <li><strong>DirectX:</strong> ${datos.rec_dx}</li>
                        <li><strong>Almacenamiento:</strong> ${datos.rec_disco}</li>
                    </ul>
                </div>

                <div class="text-center">
                    <h3 class="seccion-titulo">Instrucciones</h3>
                </div>
                <ol class="lista-instrucciones ms-3 mb-5">
                    ${listaInstruccionesBase}
                </ol>
                ...
                <div class="text-center p-4 bg-light border rounded-1">
                    ...
                    <h4 class="fw-bold mb-4">DESCARGAR UPDATE</h4>
                    <a href="${datos.link_update}" target="_blank" class="btn btn-mega-verde btn-lg fw-bold px-5 py-3">
                        <i class="fa-solid fa-magnet me-2"></i> DESCARGAR UPDATE
                    </a>
                    ` : ''}
                </div>
            ...
            <div class="col-lg-3 mt-4 mt-lg-0">
                <div class="bg-dark text-white text-center p-4 rounded-1 h-100 d-flex flex-column justify-content-center align-items-center">
                    <p class="text-uppercase fw-bold text-muted mb-2">Espacio Publicitario</p>
                    <h4 class="fw-bold">ESPACIO PUBLICITARIO</h4>
                </div>
            </div>
        </div>
    </div>
...
function generarTarjetaIndexHTML(idJuego, datos, nombreImagen) {
    return `<div class="col-md-4 col-sm-6 juego-tarjeta" data-categoria="${(datos.categoria || '').toLowerCase()}" data-requisitos="${(datos.requisitos || '').toLowerCase()}">
        <a href="juegos/${idJuego}.html" class="text-decoration-none text-dark game-post">
            ...
            <p class="text-muted" style="font-size: 0.75rem;">${datos.categoria}, ${datos.requisitos} Requisitos</p>
        </a>
    </div>
    `;
}

// 🔥 FUNCIÓN DE LIMPIEZA ANTIDUPLICADOS CON ESCÁNER INTEGRADO
function eliminarTarjetaIndex(idJuego) {
    ...
    // CASO A: Si el juego ya tiene las marcas de anclaje (creado por el panel)
    ...
    // CASO B: Escáner de seguridad extra (Para borrar tarjetas manuales y evitar duplicación en la edición)
    const enlaceObjetivo = `href="juegos/${idJuego}.html"`;
    let posHref = indexHtml.indexOf(enlaceObjetivo);
    
    // Bucle "while" por si hay duplicados previos creados por error, los limpia todos
    while (posHref !== -1) {
        ...
        // Buscar si queda algún otro duplicado del mismo ID
...
app.post('/api/crear', upload.single('imagen'), (req, res) => {
    ...
    // Evitar duplicar si se intenta crear uno con el mismo nombre
    ...
    const nuevoRegistro = { id: idJuego, imagen: nombreImagen, fecha: fechaFinal, fecha_actualizacion: fechaFinal, ...datos };
...
app.post('/api/editar', upload.single('imagen'), (req, res) => {
    ...
    const fechaActual = juegos[idx].fecha;
    ...
    fs.writeFileSync(rutaJuego, generarHTMLJuego(datos, nombreImagen, fechaActual));

    // 🔥 AHORA SÍ: Limpia la tarjeta vieja (con o sin marcas) antes de poner la actualizada
    eliminarTarjetaIndex(idJuego);
...
juegos[idx] = { ...juegos[idx], ...datos, imagen: nombreImagen, fecha: datos.fecha_actualizacion || fechaActualFallback };    guardarJuegosDB(juegos);

    res.redirect('/admin.html?msg=editado');
});

app.listen(PORT, () => {
    console.log(`✅ Servidor CMS NexusGames blindado contra duplicados en puerto: ${PORT}`);
});